var rule = {
  ...
  二级: {
    ...
    desc: '.stui-content__detail p:eq(3)&&Text;.stui-content__detail&&p:eq(-2)&&a:eq(2)&&Text;.stui-content__detail&&p:eq(-2)&&a:eq(1)&&Text;.stui-content__detail p:eq(0)&&Text;.stui-content__detail p:eq(1)&&Text',
